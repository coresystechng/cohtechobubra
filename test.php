...
<body>
  ...
  <ul id="slide-out" class="sidenav sidenav-fixed">
    <li><div class="user-view">
      ...
      <a href="#profile"><span class="white-text name">Jane Doe</span></a>
      <a href="#profile"><span class="white-text email">jane.doe@example.com</span></a>
    </div></li>
            ...
            <div class="col s12 m12">
              <ul class="collection">
                <li class="collection-item">
                  <strong>Full Name:</strong> Jane Doe
                </li>
                <li class="collection-item">
              ...
              <a href="#!" class="btn waves-effect blue">
