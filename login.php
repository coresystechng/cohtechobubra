					...
					<div class="container section">
						...
						<div class="row section">
							...
							<div class="col l8 m4 s12">
								<br>
								<p class="red-text center-align"><?php echo $error_msg ?></p>
								<form action="login.php" method="post" class="container">
									...
									<div class="center-align">
										...
										<br><br><br>
										<span>New Student? <a  class="theme-color-text underline" href="registration.php">Start Your Registration </a></span>
									</div>
								</form>
							</div>
